export default class DragLine {
    ...
    init() {
        ...
        let moving = false;
        const actStart = e => {
            console.log(moving, e.type, firstTouch.state);
            ...
            actEnd = () => {
                ...
                for (let item of this.items) {
                    ...
                    console.log(is_object, _is_object);
            ...
            if (this.isTouch) {
                if (!firstTouch.state) {
                    ...
                    value = is_object ? firstTouch.item.dataset.lineObject : firstTouch.item.dataset.lineTarget;
                    _x = e.clientX ? e.clientX : e.targetTouches[0].clientX;
                    _y = e.clientY ? e.clientY : e.targetTouches[0].clientY;
