...
export const global = {
    ...
    deviceInfo: ['android', 'iphone', 'ipod', 'ipad', 'blackberry', 'windows ce', 'windows','samsung', 'lg', 'mot', 'sonyericsson', 'nokia', 'opeara mini', 'opera mobi', 'webos', 'iemobile', 'kfapwi', 'rim', 'bb10'],
    data: {},
    exe: {},
    callback: {},
    state: {
        ...
        device: {
            info: (() => {
                for (let i = 0, len = global.deviceInfo.length; i < len; i++) {
                    if (UA.match(global.deviceInfo[i]) !== null) {
                        return global.deviceInfo[i];
                    }
                }
            })(),
